...
class Notification(models.Model):
    ...
    NOTIFICATION_TYPES = [
        ...
        ('direct_chat_request', 'Direct Chat Request'),
        ('direct_chat_accepted', 'Direct Chat Accepted'),
        ('direct_chat_rejected', 'Direct Chat Rejected'),
...
class DirectChatRequest(models.Model):
    """Direct chat request between nearby users"""
    ...
    sender = models.ForeignKey(
        User,
        on_delete=models.CASCADE,
        related_name='sent_direct_chat_requests',
        help_text="User sending the chat request"
    )
    receiver = models.ForeignKey(
        User,
        on_delete=models.CASCADE,
        related_name='received_direct_chat_requests',
        help_text="User receiving the chat request"
    )
    reason = models.TextField(
        max_length=500,
        help_text="Reason for wanting to chat"
    )
